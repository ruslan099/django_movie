    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='fild_actor', to='movies.actor', verbose_name='актеры')),
                ...
                ('directors', models.ManyToManyField(related_name='fild_director', to='movies.actor', verbose_name='режиссер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.CharField(default=0, max_length=5, verbose_name='Значение')),
            ],
            options={
